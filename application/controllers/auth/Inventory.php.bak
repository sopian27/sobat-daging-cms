...
class Inventory extends CI_Controller
{
    ...
    public function index()
    {
        ...
        //$data['id_trx_inv'] = "INV-PO-" . $num_padded . "/" . $currentDate;
    ...
    public function inventorySaveInvMenu()
    {
        ...
        $getSupplierId = $this->sup_model->getWhere('nama', $where_sup);
        //$getBarangId = $this->brg_model->getWhere('barang',$where_brg);
    ...
    */
    ...
    public function inventorySavePSTMenu()
    {
        ...
        if ($_POST['gudang'] == 'pusat') {
            ...
            if ($this->load->model("TRXPSTPusatModel")->saveData($_POST) > 0) {
                echo json_encode("Suksess");
            } else {
                echo json_encode("Failed");
            }
            ...
            if ($this->load->model("TRXPSTSobatModel")->saveData($_POST) > 0) {
                echo json_encode("Suksess");
            } else {
                echo json_encode("Failed");
            }
