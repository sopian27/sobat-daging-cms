...
<div class="container-fluid mt-3">
    <div class="container">
        <div class="row justify-content-center" style="background-color: #F4F4F4;padding:30px;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 offset-md-2" style="color:black;margin-top:60px">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" style="border-bottom:none;color:black" class="form-control" id="nama_pelanggan" name="nama_pelanggan" value="<?php echo ":&nbsp; " . ucwords($data['trxOrderDataTrx'][0]['nama_pelanggan']) ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="" class="col-sm-4 col-form-label" style="margin-top: -10px;">Nomor Hp</label>
                            <div class="col-sm-4">
                                <input type="text" style="border-bottom:none;color:black" class="form-control" id="nomor_hp" name="nomor_hp" value="<?php echo ":&nbsp; " . $data['trxOrderDataTrx'][0]['nomor_hp1'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="" class="col-sm-4 col-form-label" style="margin-top: -10px;">Alamat Pengiriman </label>
                            <div class="col-sm-4">
                                <input type="text" style="border-bottom:none;color:black" class="form-control" id="alamat_pengiriman" name="alamat_pengiriman" value="<?php echo ":&nbsp; " . $data['trxOrderDataTrx'][0]['alamat1'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="" class="col-sm-4 col-form-label" style="margin-top: -10px;">Tanggal Pengiriman</label>
                            <div class="col-sm-4">
                                <input type="text" style="border-bottom:none;color:black" class="form-control" id="tanggal_pengiriman" name="tanggal_pengiriman" value="<?php echo ":&nbsp; " . dateForShow($data['trxOrderDataTrx'][0]['tgl_pengiriman']) ?>">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <h2 style="color:black" class="text-center">Surat Jalan</h2>
                        ...
                        <div class="row mt-2 ">
                            <table class="table table-bordered data" id="tableInv" style="  border-width:1px;border-style: solid;border-color: black;">
                                ...
                                <tbody id='tbody-table-data'>
                                    <?php for ($i = 0; $i < count($data['trxOrderDataTrx']); $i++) { ?>
                                        <tr>
                                            <td><?php echo ucwords($data['trxOrderDataTrx'][$i]['nama_barang']) ?></td>
                                            <td><?php echo $data['trxOrderDataTrx'][$i]['quantity'] . " " . $data['trxOrderDataTrx'][$i]['satuan'] ?></td>
                                            <td style="width: 180px;">
                                                <?php echo $data['trxOrderDataTrx'][$i]['bungkusan'] ?></td>
                                            <td style="width: 300px;"><?php echo $data['trxOrderDataTrx'][$i]['keterangan'] ?></td>
                                        <tr>
                                        <?php } ?>
                                </tbody>
                            </table>
...
<script>
    ...
    function back(){
         location.href = "<?= base_url() ?>/liveorder";
    }
