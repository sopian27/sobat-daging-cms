<div class="container mt-3">
    ...
    <div id="form-sallary">
        ...
        <div class="row mt-5" style="display: none;" id="data-content-div">
            <div class="col-12 col-md-7 offset-md-3 justify-content-center">
                ...
                <div class="row">
                    <div class="pagination-result-operational offset-7"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div style="display: none;" id="form-invoice-pembelian">
        <div class="row mt-5 justify-content-start">
            ...
            <div class="row mt-1 justify-content-end">
                <div class="col-12 col-md-7 col-lg-4 offset-lg-1">
                    <div class="form-group row" style="display: none;" id="pengeluaran-gaji-minggu-div">
                        <label for="" class="col-6 col-form-label">
                            <h5>Pengeluaran Gaji Karyawan Minggu </h5>
                        </label>
                        <div class="col-6 mt-1">
                            <h5>:&nbsp;Rp. <span id="data-content-pengeluaran-minggu"></span></h5>
                        </div>
                    </div>

                    <div class="form-group row" style="display: none;" id="pengeluaran-gaji-bulan-div">
                        <label for="" class="col-6 col-form-label">
                            <h5>Pengeluaran Gaji Karyawan Bulan</h5>
                        </label>
                        <div class="col-6">
                            <h5>:&nbsp;Rp. <span id="data-content-pengeluaran-bulan"></span></h5>
                        </div>
                    </div>

                    <hr>
                    <div class="form-group row" style="margin-top: 10px;display: none;" id="pengeluaran-gaji-total-div">
                        <label for="" class="col-6 col-form-label">
                            <h5 style="color:red">Pengeluaran Gaji Karyawan Total</h5>
                        </label>
                        <div class="col-6">
                            <h5 style="color:red">:&nbsp;Rp. <span id="data-content-pengeluaran-total"></span></h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-3">
            <div class="col-12 col-md-7 offset-md-2 justify-content-center" id="div-mingguan">
                <table class="table table-dark table-bordered data table-responsive">
                    <thead>
                        <tr>
                ...
                <div class="row">
                    <div class="pagination-result-minggu offset-7"></div>
                </div>
            </div>

            <div class="col-12 col-md-7 offset-md-2 justify-content-center" style="display:none" id="div-bulanan">
                <table class="table table-dark table-bordered data table-responsive">
                    <thead>
                        <tr>
                ...
                <div class="row">
                    <div class="pagination-result-bulan offset-7"></div>
                </div>
            </div>
        </div>
    </div>
