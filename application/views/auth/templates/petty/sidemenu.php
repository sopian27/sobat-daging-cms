        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-md-center" id="navbarResponsive">
                <ul class="navbar-nav " style="text-transform: none !important;">
                    <li class="nav-item mx-0 "><a class="nav-link py-3 px-0 px-lg-3 border border-default" href="<?= site_url() ?>/petty-cash">Petty In</a></li>
                    <li class="nav-item mx-0 "><a class="nav-link py-3 px-0 px-lg-3 border border-default" href="<?= site_url() ?>/petty-cash-out">Petty Out</a></li>
                    <li class="nav-item mx-0 "><a class="nav-link py-3 px-0 px-lg-3 border border-default" href="<?= site_url() ?>/history-petty-cash">History Petty Cash</a></li>
                </ul>
            </div>
        </div>
    </nav>