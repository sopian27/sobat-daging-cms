<body class="bg-dark text-white">
    ...
    <div class="container-fluid bg-dark" style="width: 1600px;">
        ...
        <div class="row">
            <div class="col mt-3">
                 <a href="<?php echo site_url();?>/live-order" style="color:white"><span class="fa fa-arrow-left"> Back</span><a>
            </div>
    ...
    <nav class="navbar navbar-expand-lg bg-dark text-uppercase" id="mainNav">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-md-center" id="navbarResponsive">
                <ul class="navbar-nav">
                    <li class="nav-item mx-0 "><a class="nav-link py-3 px-0 px-lg-3" href="#"></a></li>
                </ul>
            </div>
        </div>
    </nav>