...
<div class="container-fluid mt-3">
    ...
    <div class="row">
        <div class="col-md-3 offset-md-1"><?= $trx_update ?></div>
        ...
        <div class="row justify-content-center">
                ...
                <div class="col-md-7 offset-md-2">
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="purchase_from" name="purchase_from" value="<?= $supplier_name ?>">
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="row">
                <div class="col-md-7 offset-md-2 justify-content-center">
                    <div class="row">
                        <div class="col-md-1">
                            <button class="add form-control-button btn btn-outline-light"> add </button>
                        </div>
                    </div>
                    <pre>
                        <!-- <?php
                            ...
                            <tbody id='tbody-table-data'>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="data" data-dat="kode"><input type="text" name="kode" value="<?= $data_loop->kode ?>" class="form-control "></td>
                                        <td class="data" data-dat="nama_barang"><input type="text" name="nama_barang" value="<?= $data_loop->nama_barang ?>" class="form-control "></td>
                                        <td class="data" data-dat="quantity"><input type="number" name="quantity" value="<?= $data_loop->quantity ?>" class="form-control "></td>
                                        <td class="data" data-dat="satuan">
                                            <select name="satuan" id="" class="form-control">
                                                <option <?php if ($data_loop->satuan == 'Kg') {
                                                            echo "selected";
                                                        } ?> value="Kg">kg</option>
                                                <option <?php if ($data_loop->satuan == 'Dus') {
                                                            echo "selected";
                                                        } ?> value="Dus">Dus</option>
                                            </select>
                                        </td>
                                        <td>
                                            <button class="delete form-control-button btn btn-outline-light btn-sm" onclick="delete_data('<?= $data_loop->id ?>')"> Delete </button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                    ...
                    <div class="row d-flex justify-content-end">
                        <div class="col-md-2">
                            <button class="form-control-button btn btn-outline-light" onclick="clearAllData();"> clear All </button>
                        </div>
                        <div class="col-md-2">
...
<script>
    ...
    */
    ...
    $(document).on('click', '.add', function() {
        var dataload = "";
        dataload += '<tr> '
        dataload += '    <td class="data" data-dat="id" style="display: none;"><input type="text" name="id" value="-2" class="form-control "></td> '
        ...
        dataload += '        <button class="delete form-control-button btn btn-outline-light btn-sm"> Delete </button> '
        dataload += '    </td> '
    ...
    function confirmData() {
        ...
        for (let i = 0; i < dataTableLength; i++) {
            ...
            po_id.setAttribute('value', '<?= $trx_update ?>')
